...
class Settings {
    static let scanAllDevices = Preset<Bool>(key: "scanAllDevices", defaultValue: false)
    ...
    static let displayStyle = Preset<Int>(key: "displayStyle", defaultValue: 1)
    ...
    static let sendOnConnect = Preset<Data>(key: "sendOnConnect", defaultValue: "Il guanto è connesso".data(withFormat: .utf8))
